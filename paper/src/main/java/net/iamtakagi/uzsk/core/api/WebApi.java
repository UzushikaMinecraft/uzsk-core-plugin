...
public class WebApi {
    ...
    public static ServerStatus getServerStatus(String serverName) throws IOException {
        OkHttpClient client = new OkHttpClient();
        Request request = new Request.Builder().url(Core.getInstance().getCoreConfig().getWebApiSettings().getEndpointUrl() + "/servers/" + serverName).build();
